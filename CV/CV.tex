...
\begin{itemize}
\item (with Jehanne Dousse) Andrews--Gordon type identities with parity restrictions through particle motion 
...
\item (with Benedek Dombos) Grounded partitions of type \( A_1^{(1)} \) at levels \( 1 \) and \( 2 \): bijections, affine crystal graphs, and partition identities
\end{itemize}

\subsection*{Published:}
\begin{etaremune}
\item (with Jang Soo Kim, Jianping Pan, Joseph Pappe, Anne Schilling) Hook-valued tableau uncrowding and tableau switching, {\it SIAM Journal on Discrete Mathematics}, Volume 40, Issue 1, (2026)
\item (with Minho Song) Combinatorics of orthogonal polynomials on the unit circle, {\it The Ramanujan Journal}, Volume 68, (2025) 
...
\item (with Mark Kempton, Sooyeong Kim, Adam Knudson, Neal Madras, Minho Song) Kemeny’s constant and enumerating Braess edges in trees, {\it Linear and Multilinear Algebra}, Volume 73, 1529-1565, (2025)
...
\item (with Byung-Hak Hwang, Jaeseong Oh) A combinatorial model for the transition matrix between the Specht and \( SL_2 \)-web bases,
...
\begin{itemize}
\item (with Jang Soo Kim, Jianping Pan, Joseph Pappe, Anne Schilling) A hidden symmetry of refined canonical stable Grothendieck polynomials, {\it S\'eminaire Lotharingien de Combinatoire}, 93B\#18, (2025)
\item (with Byung-Hak Hwang, Jang Soo Kim, Minho Song, U-keun Song) Refined canonical stable Grothendieck polynomials and their duals,
  {\it S\'eminaire Lotharingien de Combinatoire}, 89B\#31, (2023)
\item (with Byung-Hak Hwang, Jaeseong Oh) A combinatorial model for the transition matrix between the Specht and web bases,
  {\it S\'eminaire Lotharingien de Combinatoire}, 86B\#34, (2022)
\end{itemize}
...
\begin{etaremune}
\item Particle motion, \href{https://math-cal.cloud.science.psu.edu/events/84321}{Combinatorics/Partition Seminar at Penn State University}, Online, April 28, (2026)
\item Grounded partitions, \href{https://sites.google.com/view/cart-kias/}{CART Seminar (KIAS, SKKU)}, Online, Mar 20, (2026)
\item Refined canonical stable Grothendieck polynomials,
  \href{https://indico.math.cnrs.fr/event/15923/}{Séminaire Combinatoire et Théorie des Nombres ICJ}, Université Lyon 1, France, Mar 10, (2026)
\item Grounded partitions of type \( A_1^{(1)} \) at levels \( 1 \) and \( 2 \),  \href{https://math.skku.edu/math/community/seminar.do?mode=view&articleNo=211885&article.offset=0&articleLimit=10}{Special seminar}, Sungkyunkwan University, Korea, Jan 20, (2026)
\item Decompositions of integer powers via the Catalan and Motzkin arrays and odd-indexed Fibonacci numbers, \href{https://meetings.ams.org/math/jmm2026/meetingapp.cgi/Paper/54444}{Joint Mathematics Meetings 2026}, Washington, D.C., USA, Jan 4-7, (2026)
\item Andrews--Gordon and Stanton type identities: bijective and Bailey lemma approaches, \href{https://www.mat.univie.ac.at/~slc/wpapers/s94.html}{SLC 94}, Bad Boll, Germany, Sep 14-17, (2025)
